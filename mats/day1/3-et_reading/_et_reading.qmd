...
## Eye movements^[@rayner_eye_2009-1]
...
knitr::include_graphics(here::here("mats/day1/3-et_reading/images/SR_Research.png"))
```
...
e.g., The 
      They key on the cabinets is on the table.
...
::: {.column width="60%"}
![](images/crit_trial_px03.mov){fig-align="center" width="100%"}
:::
