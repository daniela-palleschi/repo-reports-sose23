...
::: {.content-visible when-format="pdf" when-format="html"}
:::: columns
::: {.column width="33%"}
Jeep Wrangler
...
::: {.column width="33%"}
Wrangler Jeans
![](images/wrangler_jeans.jpeg){width="100"}
:::
::: {.column width="33%"}
Cowboys
![](images/wrangler_cowboy-01.jpeg){width="150"}
:::
::::
:::
...
::: footer
Source: https://psyteachr.github.io/ads-v2/08-tidy.html#long-to-wide
:::
...
|                  |                                                    |
|------------------|----------------------------------------------------|
| `read_csv()`     | log-transform a continuous variable                |
| `rename()`       | rename variables                                   |
| `relocate()`     | move variables                                     |
| `mutate()`       | change or create new variables                     |
| `if_else()`      | condition for \`mutate()\`                         |
| `case_when()`    | can handle multiple conditions for \`mutate()\`    |
